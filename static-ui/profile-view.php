...
<?php require_once("update-profile.php");?>
	...
	<div id="carouselExampleIndicators" class="carousel slide carousel-background mt-5" data-ride="carousel">
		...
		<div class="carousel-inner">
			<div class="carousel-item active">
				<img src="../sample-images/sample-image-1.jpg" class="img-responsive first-slide" alt="first sample image"/>
			...
			<div class="carousel-item">
				<img src="../sample-images/sample-image-2.jpg" class="img-responsive first-slide" alt="first sample image"/>
				<div class="text-white mt-5">
			...
			<div class="carousel-item">
				<img src="../sample-images/sample-image-3.jpg" class="img-responsive first-slide" alt="first sample image"/>
				<div class="text-white mt-5">
					<div class="row mx-auto d-flex justify-content-center text-center col-12 col-md-5  align-items-center mt-5 mb-4">
			...
			<div class="carousel-item">
				<img src="../sample-images/sample-image-4.jpg" class="img-responsive first-slide" alt="first sample image"/>
				<div class="text-white mt-5">
					<div class="row mx-auto d-flex justify-content-center text-center col-12 col-md-5  align-items-center mt-5 mb-4">
			...
			<div class="carousel-item">
				<img src="../sample-images/sample-image-5.jpg" class="img-responsive first-slide" alt="first sample image"/>
				<div class="text-white mt-5">
					<div class="row mx-auto d-flex justify-content-center text-center col-12 col-md-5 align-items-center mt-5 mb-4">
