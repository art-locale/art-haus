...
/**
 * api for signing up too Art-Haus
 *
...
try {
  ...
  $pdo = $secrets->getPdoObject();
    ...
    // }
		...
		if(empty($requestObject->profilePasswordConfirm) === true) { //TODO- Do we need to add this in profile class?//
			throw(new \InvalidArgumentException ("Must input valid password", 405));
		}
...
EOF;
		...
		$swiftMessage->setFrom(["william.isengard@gmail.com" => "wisengard"]);
		/**
